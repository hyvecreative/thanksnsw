...
<!-- begin wrapper -->
 <div id="wrapper" class="wrapperhome lf-wrapper">

<!-- begin header -->
<div id="header" class="lf-home">

<div class="fm-container home-header lf-header clearfix">

<div class="fm-button"><span class="fm-bar"></span><span class="fm-bar"></span><span class="fm-bar"></span></div>
     
<div id="logo">
<a href="<?php bloginfo('url'); ?>/"><img src="<?php bloginfo('template_directory'); ?>/images/amsrologo-lf.png" alt="AMSRO Leaders Forum" /></a>
</div>

<nav>
     <?php wp_nav_menu( array( 'theme_location' => 'polling-menu', 'container_id' => 'topmenu', 'container_class' => 'a-menu', 'items_wrap' => '<ul id="mymenu">%3$s</ul>' ) ); ?>
