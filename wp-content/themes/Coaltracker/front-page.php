...
<div class="hero-slider">
    <div><img src="<?php bloginfo('template_directory'); ?>/images/polling-report-slider.jpg" alt="AMSRO" />
		<div class="slide-text-wrap text-center">
			<h2>AMSRO independent polling inquiry - final report released</h2>
			<a href="https:/amsro-polling-inquiry-final-report/" class="btn hm-more">Find out more</a>
		</div>
	</div>
