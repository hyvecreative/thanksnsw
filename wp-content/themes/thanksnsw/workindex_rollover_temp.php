<?php
/*
Template Name: workindex_rollover_temp
*/
...
query_posts('post_type=case_studies&showposts=10');?> 
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    
<div class="feeditem">    
    <!-- add thumbnail -->
<div class="casethumb">
<a href="<?php the_permalink() ?>" class="imgroll"><img src="<?php bloginfo('template_directory'); ?>/images/transimage.png" alt="<?php the_title(); ?>" /></a>
