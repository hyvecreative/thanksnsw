...
function excerpt_read_more_link($output) {
 global $post;
 return $output . ' <a href="'. get_permalink($post->ID) . '" class="btn btn-infeed">Read More »</a>';
}
...
function add_current_nav_class($classes, $item) {
    ...
    if (strpos($menu_slug,$current_post_type_slug) !== false || (is_singular('post') && 'News' == $item->title)) {
...
/********************
 * reactivate custom fields
 *********************/

add_filter('acf/settings/remove_wp_meta_box', '__return_false');

/********************
 * prepopulate application form with referring page title
 *********************/

function awi_autopopulate_job_title( $value ){
...
/*********************
 * Gravity forms export remove unwanted fields
 *********************/
